...
const CACHE = 'boo2026-flat-d4bfda0d38';
  ...
  e.waitUntil(
    caches.open(CACHE).then(function (c) {
      /* addAll атомарен: один недоступный файл обрушит установку целиком.
         ...
         cache:'reload' обязателен. По умолчанию addAll читает через HTTP-кэш
         браузера, и при обновлении в новый кэш попадают СТАРЫЕ файлы: версия
         кэша сменилась, приложение осталось прежним. Проверено на живом
         GitHub Pages — без этого флага обновление не доезжает. */
